...
import { 
  Settings, Network, BarChart3, ShieldCheck, 
  ArrowLeft, ArrowRight, ChevronDown, 
  Layers, Zap, ClipboardCheck, Plane, Ship, Truck
} from "lucide-react";
...
export default function CoordinacionLogistica() {
  ...
  // Data técnica: El "Cerebro" de la logística
  const procesosTecnicos = [
    {
      icon: <Network className="size-8 text-yellow-500" />,
      title: "Gestión Integral End-to-End",
      desc: "Control total desde la orden de compra hasta la entrega final.",
      details: "Diseñamos la arquitectura de su cadena de suministro. Coordinamos la recolección en la fábrica del proveedor (Ex-Works), gestionamos los tiempos de tránsito internacional y supervisamos la llegada a puerto, asegurando que cada eslabón esté sincronizado para evitar cuellos de botella."
    },
    {
      icon: <Settings className="size-8 text-yellow-500" />,
      title: "Optimización de Incoterms",
      desc: "Asesoría estratégica para reducir riesgos y costos operativos.",
      details: "Analizamos cuál es el término de negociación más favorable para su empresa (FOB, CIF, DDP, etc.). Nos encargamos de la contratación de seguros de carga y la mitigación de riesgos operativos, garantizando que las responsabilidades y costos estén claramente definidos en cada etapa."
    },
    {
      icon: <BarChart3 className="size-8 text-yellow-500" />,
      title: "Visibilidad y Reportes (KPIs)",
      desc: "Información en tiempo real para la toma de decisiones.",
      details: "No solo movemos carga, entregamos datos. Proporcionamos informes periódicos sobre el estatus de sus embarques, tiempos de despacho y eficiencia de costos. Esto permite a nuestros clientes proyectar inventarios de manera precisa y detectar oportunidades de ahorro en su logística recurrente."
    }
  ];
  ...
  const otrosServicios = [
    ...
    { title: "Almacén Logístico", icon: <Layers size={24} />, desc: "Resguardo y control de inventario.", href: "/servicios/almacen-logistico" },
    { title: "Asesoría Logística", icon: <ShieldCheck size={24} />, desc: "Consultoría experta en comercio.", href: "/servicios/asesoria-tecnica" },
  ];
      ...
      <main className="bg-slate-950 min-h-screen pt-32 overflow-hidden">
        ...
        <section className="container mx-auto px-6 mb-16 relative">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 text-xs font-bold uppercase tracking-[0.2em] mb-6">
              <Zap className="size-4" /> Inteligencia Logística
            </div>
            <h1 className="text-4xl md:text-6xl font-black text-white mb-6 uppercase leading-tight">
              Coordinación <span className="text-yellow-500">Logística</span>
            </h1>
            <p className="text-slate-400 text-lg md:text-xl leading-relaxed max-w-2xl">
              Integramos todos los procesos de su cadena de suministro bajo un solo punto de contacto, optimizando tiempos y eliminando sobrecostos operativos.
            </p>
          </motion.div>
        </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden border border-slate-800 aspect-video lg:aspect-square group">
                <img src="/Image/Gallery/IMG-3.webp" alt="Coordinación Logística SVL" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <h3 className="text-2xl font-black text-white uppercase mb-8">
                Estrategia <span className="text-yellow-500">Operativa</span>
              </h3>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-black text-white uppercase mb-4">
                ¿Quiere optimizar su cadena de suministros?
              </h2>
              <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
                Permítanos ser su departamento de logística externo. Nos encargamos de la complejidad mientras usted se enfoca en hacer crecer su negocio.
              </p>
        ...
        <section className="bg-slate-900/30 py-24 border-y border-slate-900">
          <div className="container mx-auto px-6">
            <h3 className="text-center text-white font-black uppercase tracking-tighter text-2xl mb-12">Soluciones <span className="text-yellow-500">Integrales</span></h3>
